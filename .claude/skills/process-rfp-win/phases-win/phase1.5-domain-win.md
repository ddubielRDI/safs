...
### Schema fidelity
2. **domain-context.json top-level keys** include `detected_at`, `selected_domain`, `confidence`, `clear_winner`, `scores`, `profile`, `custom_terminology` — evidence: list actual top-level keys found
